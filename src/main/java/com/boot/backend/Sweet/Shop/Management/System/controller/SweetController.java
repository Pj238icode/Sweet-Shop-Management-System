...
public class SweetController {
    ...
    public ResponseEntity<ApiResponse<SweetResponse>> addSweet(
            @RequestPart("sweet") SweetRequest sweet,
            @RequestPart(value = "image", required = false) MultipartFile image
    ) {
        SweetResponse response = sweetService.addSweet(sweet, image);
    ...
    public ResponseEntity<ApiResponse<SweetResponse>> updateSweet(
            ...
            @Valid
            @RequestPart("data") SweetRequest request,

            @RequestPart(value = "image", required = false) MultipartFile image
    ) {

        SweetResponse response = sweetService.updateSweet(id, request, image);
